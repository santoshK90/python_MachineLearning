...
'''
 Decorators are functions (or classes) that provide enhanced functionality to the original function (or class)
 without the programmer having to modify their structure.

 link :  https://towardsdatascience.com/python-decorators-in-oop-3189c526ead6#:~:text=Decorators%20are%20functions%20(or%20classes,and%20then%20returns%20a%20percentage.
 '''
